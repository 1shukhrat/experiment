...
cardWrapper.innerHTML = `<div class = "description">Приветствуем! <br> 
    Запоминайте пиктограммы появляющиеся в этой рамке и попробуйте их восстановить их порядок. На запоминание вам дается 1 секунда. <br>
    1 этап : Цифры <br>
    2 этап: Цветные пиктограммы <br>
    3 этап: Черно-белые пиктограммы <br>
